...
class EarthModule extends Component{
  ...
  UNSAFE_componentWillMount(){
    // console.log('插入前');
    let _this = this;
    request('https://www.changdaolife.cn/api/banner/getBanner?page=earth')
    .then(res => {
      console.info(res);
    ...
    return (
      <div className={style["element-content"]}>
        ...
        <div className={style["banner-content"]}>
          <Upload
            action="https://www.changdaolife.cn/api/banner/setBanner?page=earth"
